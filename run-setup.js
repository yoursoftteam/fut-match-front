...
try {
  if (!fs.existsSync(betDir)) {
    ...
    console.log(`✓ Directory already exists: ${betDir}`);
  }
} catch (err) {
...
console.log(\`✓ Total files created: \${successCount}/8\`);
console.log(\`✓ Directory: \${betDir}\`);
