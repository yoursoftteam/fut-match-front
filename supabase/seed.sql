...
-- After reset, run: node supabase/seed.mjs to create test users

BEGIN;

-- ==================== USERS (placeholder IDs, real users created by seed.mjs) ====================
-- admin@gmail.com   → c12dfbb2-35d2-42b7-b168-be5a16e8b163
-- user@gmail.com    → 26413efe-1ca1-400c-96df-a6257048b96c
-- user2@gmail.com   → 373cc72a-cac0-4b21-a3ac-e14102459ffb
-- user3@gmail.com   → fba6727c-a21f-4e01-a9d5-0a27275f20c4
